...
landscape:  load   r7, $0810            ; draw first block 
            load   r8, $3060             
            call   gfx_fill_rect
            lbdf   error
            ...
            load  r7, $2F38             ; draw notch at bottom
            load  r8, $1010             
            call  gfx_fill_rect
            lbdf  error
...
portrait:   load  r7, $1008             ; draw rectangle inside first
            load  r8, $6030             
            call  gfx_fill_rect
            lbdf  error
            ...
            load  r7, $6018             ; draw rectangle at bottom
            load  r8, $1010             
            call  gfx_fill_rect
            lbdf  error
