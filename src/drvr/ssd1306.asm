;-------------------------------------------------------------------------------
; ssd1306 - a video driver for updating an SSD1306 OLED display via
...
load:           LOAD rc, END_DRIVER - BEGIN_DRIVER        ; load block size
                ...
                pop   rc              ; restore allocated size count
...
dma_init:       db      $19 | $80     ; set low 6-bits of count
            ...
            ;---------------------------------------------
            ; Init sequence for SSD1306 displays.          
            ; Source: Adafruit SSD1306 Display driver      
...
OledType:       db 'SSD1306',0        ; oled type string for memory block id
